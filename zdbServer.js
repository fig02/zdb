    ...
    if (split[0] == 'b') {
        if (split[1] == 'ovl') {
            ...
            if (actorId >= 0) {
                ...
                console.log('actor file start addr: ' + actorFileStart.toString(16));
                var actorFileBreakAddr = actorFileStart + offset;
                console.log('setting a breakpoint in actor file, at address ' + actorFileBreakAddr.toString(16));
                events.onexec(actorFileBreakAddr, function () {
                    debug.breakhere();
                });
            ...
            events.onexec(parseInt(split[1]), function() {
                debug.breakhere();
            });
        }
    }
